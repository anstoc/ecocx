...
With this JSON file and the model provided in EIIXML format, `run_ecosim_experiment` the calls the EwE Run Console from the command line. The Run Console makes the described changes to the model, executes it, and writes a log file and the model outputs to disk.

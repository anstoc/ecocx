...
test_that("Full factorial sampler works", {
  ...
  factor_set=add_level_ecosim_effort(factor_set,"Baitboats","phase_out",rep(0,get_ecosim_effort_length(factor_set,"Baitboats")))
  factor_set=ecocx::add_level_ecosim_forcing(factor_set,"Tbottom","plus1deg",factor_set$forcing_functions$Tbottom$default$values+1)
  factor_set=ecocx::add_level_ecosim_forcing(factor_set,"Tbottom","min1deg",factor_set$forcing_functions$Tbottom$default$values-1)
...
test_that("Automated factor creation for elementary effects method works", {
  ...
  factor_set=add_level_ecosim_forcing(factor_set,"PPanomaly","none",rep(1,length(factor_set$forcing_functions$PPanomaly$default$values)))
  ...
  range_table=range_table[c(2:6,9),]
